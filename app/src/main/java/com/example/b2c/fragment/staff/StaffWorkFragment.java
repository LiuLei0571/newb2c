...
/**
 *相当于StaffOrderListFragmentNew
 */
public class StaffWorkFragment extends ZTHBaseFragment {
...
//                float startX = position * stu_baby_indicate_line.getWidth();
    ...
    public void initData() {
        ...
        templeBaseFragments.add(new StaffViewPagerBaseFragment(0,getActivity()));
        templeBaseFragments.add(new StaffViewPagerBaseFragment(1,getActivity()));
        templeBaseFragments.add(new StaffViewPagerBaseFragment(2,getActivity()));
        templeBaseFragments.add(new StaffViewPagerBaseFragment(3,getActivity()));
        templeBaseFragments.add(new StaffViewPagerBaseFragment(4,getActivity()));
        initIndiateWidth();
